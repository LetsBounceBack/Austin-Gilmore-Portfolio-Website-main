          ...
          <motion.div
            ...
            <div className='flex flex-wrap items-centercursor-pointer'>
              <a href="https://theretailchronicle.com/" target="_blank" rel="noopener noreferrer">
                <FaWordpress className='mr-3 text-4xl mb-4 hover:text-[#21759b]' title='WordPress' />
              </a>
              <a href="https://html.com/html5/" target="_blank" rel="noopener noreferrer">
                <TiHtml5 className='mr-3 text-4xl mb-4hover:text-[#e34f26]' title='HTML5' />
              </a>
              <a href="https://getbootstrap.com/" target="_blank" rel="noopener noreferrer">
                <FaBootstrap className='mr-3 text-4xl mb-4hover:text-purple-500' title='Bootstrap' />
              </a>
              <a href="https://react.dev/" target="_blank" rel="noopener noreferrer">
                <FaReact className='mr-3 text-4xl mb-4hover:text-blue-500' title='React' />
              </a>
              <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer">
                <SiTailwindcss className='mr-3 text-4xl mb-4hover:text-cyan-500' title='Tailwind CSS' />
              </a>
              <a href="https://www.construct.net/en" target="_blank" rel="noopener noreferrer">
                <SiConstruct3 className='mr-3 text-4xl mb-4hover:text-red-500' title='Construct 3' />
              </a>
              <a href="https://www.adobe.com/products/photoshop.html" target="_blank" rel="noopener noreferrer">
                <SiAdobephotoshop className='mr-3 text-4xl mb-4hover:text-[#00a4e4]' title='Adobe Photoshop' />
              </a>
              <a href="https://www.adobe.com/products/illustrator.html" target="_blank" rel="noopener noreferrer">
                <SiAdobeillustrator className='mr-3 text-4xl mb-4hover:text-[#fbb034]' title='Adobe Illustrator' />
              </a>
              <a href="https://www.Figma.com" target="_blank" rel="noopener noreferrer">
                <SiFigma className='mr-3 text-4xl mb-4hover:text-[#f24e1e]' title='Figma' />
              </a>
              <a href="https://github.com/LetsBounceBack" target="_blank" rel="noopener noreferrer">
                <FaGithub className='mr-3 text-4xl mb-4hover:text-[#6e5494]' title='GitHub' />
              </a>
              <a href="https://azure.microsoft.com/en-us" target="_blank" rel="noopener noreferrer">
                <SiMicrosoftazure className='mr-3 text-4xl mb-4hover:text-[#89c4ff]' title='Microsoft Azure' />
              </a>
